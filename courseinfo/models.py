...
class Course(models.Model):
    ...
    course_like = models.CharField(max_length=255, default=1)
    ...
    def get_like_update_url(self):
        return reverse('courseinfo_course_like_update_urlpattern',
                       kwargs={'pk': self.pk}
                       )

    def get_dislike_update_url(self):
        return reverse('courseinfo_course_dislike_update_urlpattern',
                       kwargs={'pk': self.pk}
                       )
