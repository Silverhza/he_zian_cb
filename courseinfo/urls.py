...
urlpatterns = [
    ...
    path('instructor/<int:pk>/likeupdate/',
         InstructorLikeUpdate.as_view(),
         name='courseinfo_instructor_like_update_urlpattern'),
    path('instructor/<int:pk>/dislikeupdate/',
         InstructorDislikeUpdate.as_view(),
         name='courseinfo_instructor_dislike_update_urlpattern'),
    ...
    path('section/<int:pk>/likeupdate/',
         SectionLikeUpdate.as_view(),
         name='courseinfo_section_like_update_urlpattern'),
    path('section/<int:pk>/dislikeupdate/',
         SectionDislikeUpdate.as_view(),
         name='courseinfo_section_dislike_update_urlpattern'),
    ...
    path('course/<int:pk>/likeupdate/',
         CourseLikeUpdate.as_view(),
         name='courseinfo_course_like_update_urlpattern'),
    path('course/<int:pk>/Dislikeupdate/',
         CourseDislikeUpdate.as_view(),
         name='courseinfo_course_dislike_update_urlpattern'),
